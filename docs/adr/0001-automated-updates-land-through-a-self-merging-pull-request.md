...
Accepted. Amended 2026-08-28: [`github-activity.yml`](../../.github/workflows/github-activity.yml) and [`wakatime-stats.yml`](../../.github/workflows/wakatime-stats.yml) are further exceptions, and had been in fact for as long as they have existed. See the Decision and the Consequence on generators that commit for themselves.
...
- **`main`'s history is mostly automated commits**, one per Refresh per week (one per Edition for the README Refreshes), each titled from the message its workflow sets.
