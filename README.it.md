...
💬 **Chiedimi di**: quella volta che ho inventato una nuova ricetta di risotto durante la quarantena o come girare una tortilla. Anche le domande relative alla programmazione sono benvenute.
...
3. ⬆️ Ha impulsato modifiche in [fbuireu/contribKit](https://github.com/fbuireu/contribKit)<br>
4. ⬆️ Ha impulsato modifiche in [fbuireu/forever-pto](https://github.com/fbuireu/forever-pto)<br>
5. ⬆️ Ha impulsato modifiche in [fbuireu/contribKit](https://github.com/fbuireu/contribKit)<br>
<!--RECENT_ACTIVITY:end-->
...
Il contenuto di questo profilo è [MIT](./LICENSE) © Ferran Buireu. I marchi di terze parti in `assets/` appartengono ai rispettivi proprietari.
